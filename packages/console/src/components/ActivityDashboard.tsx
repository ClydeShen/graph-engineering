...
/**
 * ActivityDashboard — trail-mesh analytics rendered as the home overview and on
 * /activity. All numbers are aggregations over execution_event_log +
 * scope_lineage served by GET /v1/metrics/activity — a projection of the graph,
 * not a separate usage ledger. Daily bar chart + event-type breakdown + scope
 * status mix. Shared so the home page and the Activity tab never diverge.
 */
